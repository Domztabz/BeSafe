...
import ke.co.visualdiagnoser.besafe.telemedicine.calendar.*
import ke.co.visualdiagnoser.besafe.telemedicine.calendar.setTextColorRes
...
import kotlinx.android.synthetic.main.available_time.view.*
...
class Example3EventsAdapter(val onClick: (Event) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Example3EventsViewHolder {
        return Example3EventsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.available_time, null))
    }
    ...
    inner class Example3EventsViewHolder(override val containerView: View) :
        ...
        fun bind(event: Event) {
            itemView.available_time.text = event.text
        }
    }

}

class BookAppointmentFragment : BaseFragment(), HasBackButton {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        exThreeCalendar.hasBoundaries = true
...
//                            dotView.makeInVisible()
        ...
        exThreeCalendar.monthScrollListener = {
            toolbar_title.text = "${monthTitleFormatter.format(it.yearMonth)} ${it.yearMonth.year}"
...
//             we scroll to a new month.
        ...
        exFiveNextMonthImage.setOnClickListener {
            exThreeCalendar.findFirstVisibleMonth()?.let {
                exThreeCalendar.smoothScrollToMonth(it.yearMonth.next)
            }
        }

        exFivePreviousMonthImage.setOnClickListener {
            exThreeCalendar.findFirstVisibleMonth()?.let {
                exThreeCalendar.smoothScrollToMonth(it.yearMonth.previous)
            }
        }
            ...
            override fun bind(container: MonthViewContainer, month: CalendarMonth) {
                ...
                if (container.legendLayout.tag == null) {
                    ...
                    container.legendLayout.children.map { it as TextView }.forEachIndexed { index, tv ->
                        ...
                        tv.setTextColorRes(R.color.dark_cerulean_2)
//                        tv.setTextColor(R.color.example_3_black)
                    }
                }
            }
        }
