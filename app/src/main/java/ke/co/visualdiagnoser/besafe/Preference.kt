...
object Preference {
    ...
    private const val POST_COUNTY = "POST_COUNTY"
    ...
    fun putCounty(context: Context, state: String): Boolean {
        return context.getSharedPreferences(PREF_ID, Context.MODE_PRIVATE)
                .edit().putString(POST_COUNTY, state).commit()
    }

    fun getCounty(context: Context): String? {
        return context.getSharedPreferences(PREF_ID, Context.MODE_PRIVATE)
                .getString(POST_COUNTY, null)
    }
