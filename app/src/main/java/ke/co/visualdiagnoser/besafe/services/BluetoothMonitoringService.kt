package ke.co.visualdiagnoser.besafe.services
...
import ke.co.visualdiagnoser.besafe.bluetooth.BLEAdvertiser
import ke.co.visualdiagnoser.besafe.bluetooth.gatt.ACTION_RECEIVED_STATUS
import ke.co.visualdiagnoser.besafe.bluetooth.gatt.ACTION_RECEIVED_STREETPASS
import ke.co.visualdiagnoser.besafe.bluetooth.gatt.STATUS
import ke.co.visualdiagnoser.besafe.bluetooth.gatt.STREET_PASS
import ke.co.visualdiagnoser.besafe.factory.NetworkFactory
import ke.co.visualdiagnoser.besafe.logging.CentralLog
import ke.co.visualdiagnoser.besafe.notifications.NotificationTemplates
import ke.co.visualdiagnoser.besafe.receivers.PrivacyCleanerReceiver
import ke.co.visualdiagnoser.besafe.status.Status
import ke.co.visualdiagnoser.besafe.status.persistence.StatusRecord
import ke.co.visualdiagnoser.besafe.status.persistence.StatusRecordStorage
import ke.co.visualdiagnoser.besafe.streetpass.ConnectionRecord
import ke.co.visualdiagnoser.besafe.streetpass.StreetPassScanner
import ke.co.visualdiagnoser.besafe.streetpass.StreetPassServer
import ke.co.visualdiagnoser.besafe.streetpass.StreetPassWorker
...
//        broadcastMessage = Utils.retrieveBroadcastMessage(this.applicationContext)
        broadcastMessage = FirebaseAuth.getInstance().uid
    }
...
//            if (Preference.isOnBoarded(this)  && broadcastMessage == null) {
//                //need to pull new BM
//
...
//            }
            ...
            //TODO Sign out the user. Ask User to sign in
